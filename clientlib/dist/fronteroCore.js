...
/***/ function(module, exports, __webpack_require__) {
	...
	var SetupManager = _require.SetupManager;

	var _require2 = __webpack_require__(57);

	var Channel = _require2.Channel;

	var _require3 = __webpack_require__(61);

	var App = _require3.App;

	var FronteroCore = exports.FronteroCore = function () {
	    function FronteroCore() {
	        var params = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

	        _classCallCheck(this, FronteroCore);

	        var setupManager = this.setupManager = new SetupManager({
	    ...
	    _createClass(FronteroCore, [{
	        ...
	        value: function app(params) {
	            ...
	            this.app = new App(this.setupManager, params);
	            return this.app;
	        }
	    }, {
	        key: 'channel',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SetupManager = exports.SetupManager = function () {
	    function SetupManager(_config) {
	        _classCallCheck(this, SetupManager);

	        this.config = _config || {};
	        this.ajax = new Ajax(this);
	        this.io = __webpack_require__(8); //(this.config.apiEndPoint);
	    }

	    _createClass(SetupManager, [{
	        key: 'gettEndPoint',
	        value: function gettEndPoint() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ajax = exports.Ajax = function () {
	    ...
	    _createClass(Ajax, [{
	        key: 'get',
	        value: function get(relUrl, data, token) {
	            var _this = this;

	            return new Promise(function (resolve, reject) {
	                _req.get(_this.setup.getApiEndPoint() + relUrl).send(data || {}).set('Authorization', 'JWT ' + token).set('Accept', 'application/json').end(function (err, res) {
	                    if (err) {
	                        reject(err);
	                    } else {
	                        resolve(res.body);
	        ...
	        key: 'post',
	        value: function post(relUrl, data, token) {
	            var _this2 = this;

	            return new Promise(function (resolve, reject) {
	                _req.post(_this2.setup.getApiEndPoint() + relUrl).send(data || {}).set('Authorization', 'JWT ' + token).set('Accept', 'application/json').end(function (err, res) {
	                    if (err) {
	                        reject(err);
	                    } else {
	                        resolve(res.body);
	        ...
	        key: 'put',
	        value: function put(relUrl, data, token) {
	            var _this3 = this;

	            return new Promise(function (resolve, reject) {
	                _req.put(_this3.setup.getApiEndPoint() + relUrl).send(data || {}).set('Authorization', 'JWT ' + token).set('Accept', 'application/json').end(function (err, res) {
	                    if (err) {
	                        reject(err);
	                    } else {
	                        resolve(res.body);
	        ...
	        key: 'delete',
	        value: function _delete(relUrl, data, token) {
	            var _this4 = this;

	            return new Promise(function (resolve, reject) {
	                _req.delete(_this4.setup.getApiEndPoint() + relUrl).send(data || {}).set('Authorization', 'JWT ' + token).set('Accept', 'application/json').end(function (err, res) {
	                    if (err) {
	                        reject(err);
	                    } else {
	                        resolve(res.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isocket = __webpack_require__(58);
	...
	var Channel = exports.Channel = function (_ISocket) {
	    _inherits(Channel, _ISocket);

	    function Channel(setupManager) {
	        var data = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	        _classCallCheck(this, Channel);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Channel).call(this, setupManager, data));
	    }
	    ...
	    _createClass(Channel, [{
	        ...
	        value: function connect() {
	            ...
	            return new Promise(function (resolve, reject) {
	                ...
	                if (_this2.isState('connected')) {
	                    return reject(new Error('already connected'));
	                }

	                // request token
	                _this2.setupManager.ajax.post('/token-channel', _this2._data).then(function (res) {
	                    // success
	                    if (res && res.token && res.app) {

	                        _get(Object.getPrototypeOf(Channel.prototype), 'connect', _this2).call(_this2, res.token).then(function () {
	                            // on success
	                            resolve(_this2);
	                        }, function (err) {
	                            // on fail
	                            reject(err);
	                            _this2.setState("disconnected");
	                        });
	                    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ISocket = undefined;

	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

	var _isocketAnalyticsCollector = __webpack_require__(59);

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

	var ISocket = exports.ISocket = function () {
	    function ISocket(setupManager) {
	        var data = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
	        ...
	        this.analytics = new _isocketAnalyticsCollector.ISocketAnalyticsCollector(this.setupManager);
	    }
	    ...
	    _createClass(ISocket, [{
	        ...
	        value: function connect(token) {
	            ...
	            return new Promise(function (resolve, reject) {
	                ...
	                _this.socket = _this.setupManager.io.connect(_this.setupManager.gettEndPoint(), data);

	                _this.socket.on('connect', function () {
	                    _this.setState("connected");
	                    _this.token = token; // that token worked! keep it!
	                    resolve(_this);
	                });
	                ...
	                _this.socket.on('push:added', function (data) {
	                    _this._eventsHandlers['push:added'] && _this._eventsHandlers['push:added'](data);
	                });

	                _this.socket.on('push:edited', function (data) {
	                    _this._eventsHandlers['push:edited'] && _this._eventsHandlers['push:edited'](data);
	                });

	                _this.socket.on('push:deleted', function (data) {
	                    _this._eventsHandlers['push:deleted'] && _this._eventsHandlers['push:deleted'](data);
	                });

	                _this.socket.on('disconnect', function () {
	                    _this.setState("disconnected");
	                    _this._eventsHandlers['disconnected'] && _this._eventsHandlers['disconnected']();
	                });
	            });
	        }
	    }, {
	        ...
	        value: function send(eventName, data) {
	            ...
	            var isMeasured = !eventName.startsWith('analytics');
	            var measuredTag = void 0;
	            return new Promise(function (resolve, reject) {
	                if (_this2.socket) {

	                    // ~~~ MEASURE START
	                    if (isMeasured) {
	                        measuredTag = _this2.analytics.startMeasurement(eventName);
	                    }

	                    // ~~~ SEND DATA
	                    _this2.socket.emit(eventName, data, function (err, data) {
	                        if (err) {

	                            // ~~~ MEASURE END
	                            isMeasured && _this2.analytics.endMeasurement(measuredTag, {
	                                result: false
	                            });
	        ...
	        key: 'getCollectedAnalytics',
	        value: function getCollectedAnalytics() {
	        ...
	        value: function updateAnalytics() {
	            ...
	            return new Promise(function (resolve, reject) {
	                if (_this3.isConnected()) {
	                    var measurements = _this3.getCollectedAnalytics();
	                    if (Object.keys(measurements).length > 0) {
	                        _this3.send('analytics:add', measurements).then(resolve, reject);
	                    } else {
	                        resolve(false);
	                    }
	                } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ISocketAnalyticsCollector = exports.ISocketAnalyticsCollector = function () {
	    function ISocketAnalyticsCollector(setupManager, params) {
	        _classCallCheck(this, ISocketAnalyticsCollector);
	    ...
	    _createClass(ISocketAnalyticsCollector, [{
	        key: 'startMeasurement',
	        value: function startMeasurement(op) {
	            var ts = new Date();
	            var tag = 'op_' + ts;
	        ...
	        key: 'endMeasurement',
	        value: function endMeasurement(tag, params) {
	            var mes = this._data.activeMeasurements[tag];
	            if (mes) {
	                var ts = mes.timestamp;
	        ...
	        value: function getMeasurements() {
	            var data = this._data.finishedMeasurements; // keep data for us to send to server
	            this._data.finishedMeasurements = []; // clear in the meantime
	            return data;
	        }
	    }]);

	    return ISocketAnalyticsCollector;
	}();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = exports.App = function (_ISocket) {
	    _inherits(App, _ISocket);

	    function App(setupManager) {
	        var data = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	        _classCallCheck(this, App);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(App).call(this, setupManager, data));
	    }
	    ...
	    _createClass(App, [{
	        ...
	        value: function connect() {
	            ...
	            return new Promise(function (resolve, reject) {
	                ...
	                // request token
	                _this2.setupManager.ajax.post('/token-app', _this2._data).then(function (res) {
	                    // success
	                    if (res && res.token && res.app) {

	                        _get(Object.getPrototypeOf(App.prototype), 'connect', _this2).call(_this2, res.token).then(function () {
	                            // on success
	                            resolve(_this2);
	                        }, function (err) {
	                            // on fail
