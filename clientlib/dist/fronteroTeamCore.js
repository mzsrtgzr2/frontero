...
/***/ function(module, exports, __webpack_require__) {
	...
	var Developer = _require2.Developer;

	var _require3 = __webpack_require__(63);

	var App = _require3.App;

	var _require4 = __webpack_require__(64);

	var Debug = _require4.Debug;

	var FronteroTeamCore = function () {
	    function FronteroTeamCore(params) {
	        _classCallCheck(this, FronteroTeamCore);
	    ...
	    _createClass(FronteroTeamCore, [{
	        ...
	        value: function authenticate(params) {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this.setupManager.ajax.post('/token-developer', params).then(function (res) {
	                    // success
	                    if (res && res.token && res.developer) {
	                        _this._tokenDeveloper = res.token;
	                        _this.setupManager.tokenDeveloper = res.token;

	                        _this._developer = null; // clear existing developer mem
	                        _this.developer(res.developer._id, res.developer); // create our developer mem
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Developer = exports.Developer = function () {
	    function Developer(setupManager, _id) {
	    ...
	    _createClass(Developer, [{
	        ...
	        value: function getApps() {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this.setupManager.ajax.get('/apps', {}, _this.setupManager.tokenDeveloper).then(function (res) {
	                    // success
	                    var apps = [];
	                    res.forEach(function (app) {
	                        apps.push(new App(_this.setupManager, app._id, app));
	                    });
	                    resolve(apps);
	                }, function (err) {
	                    // fail
	        ...
	        value: function create(data) {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this2.setupManager.ajax.post('/developer/', data).then(function (res) {
	                    // success
	                    _this2._data = res;
	                    _this2._data.password = undefined; // dont keep password
	                    _this2._id = res._id;
	                    resolve(res);
	                }, function (err) {
	                    reject(err);
	        ...
	        key: 'createApp',
	        value: function createApp(data) {
	            var _this3 = this;

	            return new Promise(function (resolve, reject) {
	                _this3.setupManager.ajax.post('/app/', data, _this3.setupManager.tokenDeveloper).then(function (res) {
	                    // success
	                    resolve(new App(_this3.setupManager, res._id, res));
	                }, function (err) {
	                    reject(err);
	                });
	            });
	        ...
	        value: function update(data) {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this4.setupManager.ajax.put('/developer/' + _this4._id, data, _this4.setupManager.tokenDeveloper).then(function (res) {
	                    // success
	                    _this4._data = res;
	                    _this4._id = res._id;
	                    resolve(res);
	        ...
	        value: function _delete() {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this5.setupManager.ajax.delete('/developer/' + _this5._id, {}, _this5.setupManager.tokenDeveloper).then(function (res) {
	                    // success
	                    _this5._data = undefined;
	                    _this5._id = undefined;
	                    resolve(res);
	                }, function (err) {
	                    reject(err);
	                });
	...
	var App = exports.App = function () {
	    ...
	    _createClass(App, [{
	        ...
	        value: function get() {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this.setupManager.ajax.get("/app/" + _this._id, {}, _this.setupManager.tokenDeveloper).then(function (res) {
	                    // success
	                    _this._data = res;
	                    _this._id = res._id;
	                    resolve(res);
	        ...
	        value: function update(data) {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this2.setupManager.ajax.put("/app/" + _this2._id, data, _this2.setupManager.tokenDeveloper).then(function (res) {
	                    // success
	                    _this2._data = res;
	                    _this2._id = res._id;
	                    resolve(res);
	        ...
	        value: function _delete() {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this3.setupManager.ajax.delete("/app/" + _this3._id, {}, _this3.setupManager.tokenDeveloper).then(function (res) {
	                    // success
	                    _this3._data = undefined;
	                    _this3._id = undefined;
	                    resolve(res);
	                }, function (err) {
	                    reject(err);
	                });
	        ...
	        value: function regenerateSecret() {
	            var _this4 = this;

	            return new Promise(function (resolve, reject) {
	                _this4.setupManager.ajax.post("/app/" + _this4._id + "/secret", {}, _this4.setupManager.tokenDeveloper).then(function (res) {
	                    // success
	                    _this4._data.secret = res;
	                    resolve(res);
	                }, function (err) {
	                    reject(err);
	                });
...
/***/ function(module, exports) {
	...
	var Debug = exports.Debug = function () {
	    ...
	    _createClass(Debug, [{
	        ...
	        key: "set_bruteforce",
	        value: function set_bruteforce(value) {
	            return this.setupManager.ajax.get("/debug/set_bruteforce/" + value);
	        }
	    }, {
	        key: "set_app_limits",
	        value: function set_app_limits(value) {
